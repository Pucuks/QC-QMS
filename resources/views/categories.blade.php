...
@section('title', __('Documents Categories'))
@section('custom-css')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" id="save" action="{{ route('documents.categories.save') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="delete-category">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" id="delete" action="{{ route('documents.categories.delete') }}" method="post">
                        @csrf
                        @method('delete')
